  ...
  constructor(props) {
    ...
    this.state = {
      ...
      active: props.active
		...
		this.buttonAnim = new Animated.Value(-2);
	...
	componentDidMount() {
		Animated.timing(
			...
			{
				toValue: 1,
				duration: this.props.timeToFullOpacity,
			}
		).start();
	}
...
ActionButton.propTypes = {
  ...
  nativeFeedbackRippleColor: PropTypes.string,
	...
	timeToFullOpacity: PropTypes.number
};
